...
# get file
wget -O /etc/vip.zip "https://raw.githubusercontent.com/reyluar03/geforce/master/centos6/vip.zip"
cd /etc/
unzip vip.zip
cd
...
#get active.txt 
wget https://raw.githubusercontent.com/reyluar03/geforce/master/ssh/vipactive.sh
wget https://raw.githubusercontent.com/reyluar03/geforce/master/ssh/vipnotactive.sh
