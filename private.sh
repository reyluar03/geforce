...
# get file
wget -O /etc/private.zip "https://raw.githubusercontent.com/reyluar03/geforce/master/centos6/private.zip"
cd /etc/
unzip private.zip
cd
...
#get active.txt
cd
wget https://raw.githubusercontent.com/reyluar03/geforce/master/ssh/privateactive.sh
wget https://raw.githubusercontent.com/reyluar03/geforce/master/ssh/privatenotactive.sh
